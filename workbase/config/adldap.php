            ...
            */
            ...
            'connection_settings' => [
                ...
                */
                ...
                'account_suffix' => env('ADLDAP_ACCOUNT_SUFFIX', '@HOSTED.LAC.COM'),
                ...
                */
                ...
                'domain_controllers' => explode(' ', env('ADLDAP_CONTROLLERS', 'LDAP.HOSTED.LAC.COM')),
                ...
                */
                ...
                'base_dn' => env('ADLDAP_BASEDN', 'OU=D325,OU=Departments,DC=HOSTED,DC=LAC,DC=COM'),
                ...
                */
                ...
                'admin_account_suffix' => env('ADLDAP_ADMIN_ACCOUNT_SUFFIX', '@HOSTED.LAC.COM'),
                ...
                */
                ...
                'admin_username' => env('ADLDAP_ADMIN_USERNAME', 'svc_laravel'),
                'admin_password' => env('ADLDAP_ADMIN_PASSWORD', 'Hosted4lar!'),
